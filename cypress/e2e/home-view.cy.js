describe('Test HomeView', () => {
  beforeEach(() => {
    ...
    .visit('https://petbook-5fjgm51ku-paulina-isabel.vercel.app/')
  })

  it('should display header', () => {
    cy.visit('https://petbook-5fjgm51ku-paulina-isabel.vercel.app/')
    cy.get('.petbook-logo')
  ...
  it('should take you to pet details when link is clicked', () => {
    ...
    cy.get(':nth-child(1) > .info-container > a > .detail-link-icon').first().click()
      .url().should('eq', 'https://petbook-5fjgm51ku-paulina-isabel.vercel.app/1')
  })
  ...
  // it('Should display URL error page with a 404 level error', () => {
    ...
    // })
// 
    // cy.intercept('GET', 'https://petbook-5fjgm51ku-paulina-isabel.vercel.app/nonsense', {
      // statusCode: 404,
      // fixture: 'allPets.json'
    // })
// 
    // cy.intercept('GET', 'https://petbook-be-git-refactor-edit-server-name-aliceabarca.vercel.app/api/v1/pets/nonsense', {
      // statusCode: 404})
      // 
    //  cy.visit('https://petbook-5fjgm51ku-paulina-isabel.vercel.app/nonsense')
